...
export default function ArchitectureDocumentPage() {
  ...
  const handleDelete = () => {
    ...
    router.push("/product/architecture");
  };
    ...
    return (
      <div className="px-6 py-section">
        <div className="max-w-4xl mx-auto">
          ...
          <Link href="/product/architecture" className="text-linear-accent text-sm mt-2 inline-block">
    ...
    <div className="px-6 py-section">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-2 mb-6">
          <Link href="/product/architecture" className="text-sm text-linear-text-subtle hover:text-linear-text-ink transition-colors">
            ← Architecture
          </Link>
        </div>

        <Eyebrow className="text-linear-text-subtle mb-2">Architecture / Document</Eyebrow>
